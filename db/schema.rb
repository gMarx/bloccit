...
ActiveRecord::Schema.define(version: 20160309042710) do
  ...
  add_index "comments", ["commented_type", "commented_id"], name: "index_comments_on_commented_type_and_commented_id"
